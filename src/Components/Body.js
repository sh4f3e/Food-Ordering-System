...
const Body = () => {
  ...
  //`http://localhost:3000/api/restaurants?lat=11.9415915&lng=79.8083133&page_type=DESKTOP_WEB_LISTING`

  const fetchData = async () => {
    const data = await fetch(
      `http://localhost:3000/api/restaurants?lat=11.9415915&lng=79.8083133&is-seo-homepage-enabled=true&page_type=DESKTOP_WEB_LISTING`
    );
